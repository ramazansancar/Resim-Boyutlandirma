...
if(strlen($large_photo_exists)>0 && strlen($thumb_photo_exists)>0){
    ...
    echo "<p><a href=\"?a=delete&t=".$_SESSION['random_key']."&e=".$_SESSION['user_file_ext']."\">Delete images</a></p>";
...
//Clear the time stamp session and user file extension
    ...
    <?php 	} ?>
    <h2>Upload Photo</h2>
    <form name="photo" enctype="multipart/form-data" action="<?php echo "index.php";?>" method="post">
